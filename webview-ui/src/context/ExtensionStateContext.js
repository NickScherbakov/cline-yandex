...
var ExtensionStateContextProvider = function (_a) {
    ...
    var _d = (0, react_1.useState)(false), didHydrateState = _d[0], setDidHydrateState = _d[1];
    var _e = (0, react_1.useState)(false), showWelcome = _e[0], setShowWelcome = _e[1];
    var _f = (0, react_1.useState)(undefined), theme = _f[0], setTheme = _f[1];
    var _g = (0, react_1.useState)([]), filePaths = _g[0], setFilePaths = _g[1];
    var _h = (0, react_1.useState)((_b = {},
        _b[api_1.openRouterDefaultModelId] = api_1.openRouterDefaultModelInfo,
        _b)), openRouterModels = _h[0], setOpenRouterModels = _h[1];
    var _j = (0, react_1.useState)(null), totalTasksSize = _j[0], setTotalTasksSize = _j[1];
    var _k = (0, react_1.useState)([]), openAiModels = _k[0], setOpenAiModels = _k[1];
    var _l = (0, react_1.useState)([]), mcpServers = _l[0], setMcpServers = _l[1];
    var _m = (0, react_1.useState)({ items: [] }), mcpMarketplaceCatalog = _m[0], setMcpMarketplaceCatalog = _m[1];
        ...
        switch (message.type) {
            case "state": {
                ...
                var hasKey = config
                    ...
                    ].some(function (key) { return key !== undefined; })
                    : false;
            ...
            case "partialMessage": {
                ...
                setState(function (prevState) {
                    ...
                    var lastIndex = (0, array_1.findLastIndex)(prevState.clineMessages, function (msg) { return msg.ts === partialMessage_1.ts; });
                    if (lastIndex !== -1) {
            ...
            case "openRouterModels": {
                ...
                setOpenRouterModels(__assign((_a = {}, _a[api_1.openRouterDefaultModelId] = api_1.openRouterDefaultModelInfo, _a), updatedModels));
                break;
            }
            case "openAiModels": {
    ...
    var contextValue = __assign(__assign({}, state), { didHydrateState: didHydrateState, showWelcome: showWelcome, theme: theme, openRouterModels: openRouterModels, openAiModels: openAiModels, mcpServers: mcpServers, mcpMarketplaceCatalog: mcpMarketplaceCatalog, filePaths: filePaths, totalTasksSize: totalTasksSize, setApiConfiguration: function (value) {
            return setState(function (prevState) { return (__assign(__assign({}, prevState), { apiConfiguration: value })); });
        }, setCustomInstructions: function (value) {
            return setState(function (prevState) { return (__assign(__assign({}, prevState), { customInstructions: value })); });
        }, setTelemetrySetting: function (value) {
            return setState(function (prevState) { return (__assign(__assign({}, prevState), { telemetrySetting: value })); });
        }, setPlanActSeparateModelsSetting: function (value) {
            return setState(function (prevState) { return (__assign(__assign({}, prevState), { planActSeparateModelsSetting: value })); });
        }, setShowAnnouncement: function (value) {
            return setState(function (prevState) { return (__assign(__assign({}, prevState), { shouldShowAnnouncement: value })); });
        } });
