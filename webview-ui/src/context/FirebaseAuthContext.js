...
var FirebaseAuthProvider = function (_a) {
	...
	var signInWithToken = (0, react_1.useCallback)(
		function (token) {
	...
	var handleSignOut = (0, react_1.useCallback)(
		function () {
			return __awaiter(void 0, void 0, void 0, function () {
				var error_2
				return __generator(this, function (_a) {
	...
	return (
		<FirebaseAuthContext.Provider
			value={{ user: user, isInitialized: isInitialized, signInWithToken: signInWithToken, handleSignOut: handleSignOut }}>
			{children}
		</FirebaseAuthContext.Provider>
	)
}
