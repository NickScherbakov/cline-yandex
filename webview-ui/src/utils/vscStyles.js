...
exports.VSC_TITLEBAR_INACTIVE_FOREGROUND = exports.VSC_INACTIVE_SELECTION_BACKGROUND = exports.VSC_DIFF_INSERTED_LINE_BACKGROUND = exports.VSC_DIFF_REMOVED_LINE_BACKGROUND = exports.VSC_SIDEBAR_BORDER = exports.VSC_BADGE_FOREGROUND = exports.VSC_BADGE_BACKGROUND = exports.VSC_INPUT_BORDER_FOCUS = exports.VSC_INPUT_BORDER = exports.VSC_QUICK_INPUT_BACKGROUND = exports.VSC_LIST_ACTIVE_FOREGROUND = exports.VSC_FOCUS_BORDER = exports.VSC_LIST_SELECTION_BACKGROUND = exports.VSC_EDITOR_BACKGROUND = exports.VSC_BUTTON_FOREGROUND = exports.VSC_BUTTON_BACKGROUND = exports.VSC_INPUT_PLACEHOLDER_FOREGROUND = exports.VSC_DESCRIPTION_FOREGROUND = exports.VSC_FOREGROUND_MUTED = exports.VSC_EDITOR_FOREGROUND = exports.VSC_FOREGROUND = exports.VSC_SIDEBAR_BACKGROUND = exports.VSC_INPUT_FOREGROUND = exports.VSC_INPUT_BACKGROUND = void 0;
...
function hexToRGB(hexColor) {
    ...
    var _a = [0, 2, 4].map(function (offset) { return parseInt(hex.slice(offset, offset + 2), 16); }), r = _a[0], g = _a[1], b = _a[2];
    return { r: r, g: g, b: b };
}
function colorToHex(colorVar) {
    ...
    return "#".concat(rgbValues.map(function (x) { return x.toString(16).padStart(2, "0"); }).join(""));
}
