...
}, exports.CODE_BLOCK_BG_COLOR, function (_a) {
    var forceWrap = _a.forceWrap;
    return (forceWrap ? "auto" : "max-content");
}, exports.CODE_BLOCK_BG_COLOR, exports.CODE_BLOCK_BG_COLOR);
...
var CodeBlock = (0, react_1.memo)(function (_a) {
    var source = _a.source, _b = _a.forceWrap, forceWrap = _b === void 0 ? false : _b;
    ...
    var _c = (0, react_remark_1.useRemark)({
        ...
        rehypeReactOptions: {
            components: {
                pre: function (_a) {
                    var node = _a.node, preProps = __rest(_a, ["node"]);
                    return <StyledPre {...preProps} theme={theme}/>;
                },
            },
        },
    }), reactContent = _c[0], setMarkdownSource = _c[1];
