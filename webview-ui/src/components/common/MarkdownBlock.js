...
var remarkPreventBoldFilenames = function () {
    return function (tree) {
        (0, unist_util_visit_1.visit)(tree, "strong", function (node, index, parent) {
            ...
            var strongContent = (_c = (_b = node.children) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.value;
...
var StyledPre = styled_components_1.default.pre(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n\t& .hljs {\n\t\tcolor: var(--vscode-editor-foreground, #fff);\n\t}\n\n\t", "\n"], ["\n\t& .hljs {\n\t\tcolor: var(--vscode-editor-foreground, #fff);\n\t}\n\n\t", "\n"])), function (props) {
...
var MarkdownBlock = (0, react_1.memo)(function (_a) {
    ...
    var _b = (0, react_remark_1.useRemark)({
        ...
        rehypeReactOptions: {
            components: {
                pre: function (_a) {
                    var _b, _c;
                    var node = _a.node, children = _a.children, preProps = __rest(_a, ["node", "children"]);
                    if (Array.isArray(children) && children.length === 1 && react_1.default.isValidElement(children[0])) {
                        var child = children[0];
                        if ((_c = (_b = child.props) === null || _b === void 0 ? void 0 : _b.className) === null || _c === void 0 ? void 0 : _c.includes("language-mermaid")) {
                            return child;
                        }
                    }
    ...
    }), reactContent = _b[0], setMarkdown = _b[1];
