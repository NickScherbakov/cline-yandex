...
var CheckmarkControl = function (_a) {
	var messageTs = _a.messageTs,
		isCheckpointCheckedOut = _a.isCheckpointCheckedOut
...
var Container = styled_components_1.default.div(
	...
	function (props) {
		return props.$isCheckedOut ? 1 : props.isMenuOpen ? 1 : 0.5
	},
)
var Label = styled_components_1.default.span(
	templateObject_2 ||
...
var DottedLine = styled_components_1.default.div(
	templateObject_3 ||
	...
	function (props) {
		return props.small ? "0 0 5px" : "1"
	},
	function (props) {
		return props.small ? "5px" : "5px"
	},
	function (props) {
		return props.$isCheckedOut ? "var(--vscode-textLink-foreground)" : "var(--vscode-descriptionForeground)"
	},
...
var CustomButton = styled_components_1.default.button(
	templateObject_5 ||
	...
	function (props) {
		return props.isActive || props.disabled ? "auto" : "4px 1px, 1px 4px, 4px 1px, 1px 4px"
	},
	function (props) {
		return props.$isCheckedOut ? "var(--vscode-textLink-foreground)" : "var(--vscode-descriptionForeground)"
	},
