...
var Thumbnails = function (_a) {
	var images = _a.images,
		style = _a.style,
		setImages = _a.setImages,
		onHeightChange = _a.onHeightChange
	var _b = (0, react_1.useState)(null),
		hoveredIndex = _b[0],
		setHoveredIndex = _b[1]
	...
	var handleDelete = function (index) {
		setImages === null || setImages === void 0
			? void 0
	...
	return (
		<div ref={containerRef} style={__assign({ display: "flex", flexWrap: "wrap", gap: 5, rowGap: 3 }, style)}>
