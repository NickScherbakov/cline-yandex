...
mermaid_1.default.initialize({
	...
	securityLevel: "loose",
	theme: "dark",
	themeVariables: __assign(__assign({}, MERMAID_THEME), {
		fontSize: "16px",
...
function MermaidBlock(_a) {
	...
	;(0, useDebounceEffect_1.useDebounceEffect)(
		function () {
	...
	var handleClick = function () {
		return __awaiter(_this, void 0, void 0, function () {
			...
			return __generator(this, function (_a) {
				switch (_a.label) {
					case 0:
						if (!containerRef.current) return [2 /*return*/]
						svgEl = containerRef.current.querySelector("svg")
						if (!svgEl) return [2 /*return*/]
						_a.label = 1
					case 1:
						_a.trys.push([1, 3, , 4])
...
function svgToPng(svgEl) {
	return __awaiter(this, void 0, void 0, function () {
		...
		return __generator(this, function (_b) {
			...
			viewBox =
				((_a = svgClone.getAttribute("viewBox")) === null || _a === void 0 ? void 0 : _a.split(" ").map(Number)) || []
...
var MermaidBlockContainer = styled_components_1.default.div(
	templateObject_1 ||
...
var LoadingMessage = styled_components_1.default.div(
	templateObject_2 ||
