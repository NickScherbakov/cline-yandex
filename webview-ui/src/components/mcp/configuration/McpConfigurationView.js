...
var McpConfigurationView = function (_a) {
	...
	var _b = (0, react_2.useState)(mcpMarketplaceEnabled ? "marketplace" : "installed"),
		activeTab = _b[0],
		setActiveTab = _b[1]
				...
				<div
					...
					{mcpMarketplaceEnabled && (
						<exports.TabButton
							...
							onClick={function () {
								return handleTabChange("marketplace")
							}}>
							Marketplace
						</exports.TabButton>
					)}
					<exports.TabButton
						...
						onClick={function () {
							return handleTabChange("addRemote")
						}}>
						Remote Servers
					</exports.TabButton>
					<exports.TabButton
						...
						onClick={function () {
							return handleTabChange("installed")
						}}>
						Installed
					</exports.TabButton>
				</div>
...
var StyledTabButton = styled_components_1.default.button(
	templateObject_1 ||
	...
	function (props) {
		return props.isActive ? "var(--vscode-foreground)" : "transparent"
	},
	function (props) {
