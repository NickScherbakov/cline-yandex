...
var AddRemoteServerForm = function (_a) {
    ...
    var _b = (0, react_1.useState)(""), serverName = _b[0], setServerName = _b[1];
    var _c = (0, react_1.useState)(""), serverUrl = _c[0], setServerUrl = _c[1];
    var _d = (0, react_1.useState)(false), isSubmitting = _d[0], setIsSubmitting = _d[1];
    var _e = (0, react_1.useState)(""), error = _e[0], setError = _e[1];
    var _f = (0, react_1.useState)(false), showConnectingMessage = _f[0], setShowConnectingMessage = _f[1];
    ...
    var handleMessage = (0, react_1.useCallback)(function (event) {
        ...
        if (message.type === "addRemoteServerResult" &&
            ...
            ((_a = message.addRemoteServerResult) === null || _a === void 0 ? void 0 : _a.serverName) === submittedValues.current.name) {
    ...
    return (<div className="p-4 px-5">
			...
			<form onSubmit={handleSubmit}>
				<div className="mb-2">
					<react_2.VSCodeTextField value={serverName} onChange={function (e) {
            setServerName(e.target.value);
            setError("");
        }} disabled={isSubmitting} className="w-full" placeholder="mcp-server">
						Server Name
					</react_2.VSCodeTextField>
				</div>

				<div className="mb-2">
					<react_2.VSCodeTextField value={serverUrl} onChange={function (e) {
            setServerUrl(e.target.value);
            setError("");
        }} disabled={isSubmitting} placeholder="https://example.com/mcp-server" className="w-full mr-4">
						Server URL
					</react_2.VSCodeTextField>
				</div>
				...
				<div className="flex items-center mt-3 w-full">
					...
					{showConnectingMessage && (<div className="ml-3 text-[var(--vscode-notificationsInfoIcon-foreground)] text-sm">
							Connecting to server... This may take a few seconds.
						</div>)}
				</div>

				<react_2.VSCodeButton appearance="secondary" style={{ width: "100%", marginBottom: "5px", marginTop: 15 }} onClick={function () {
