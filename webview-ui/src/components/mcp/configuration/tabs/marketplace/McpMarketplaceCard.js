...
var McpMarketplaceCard = function (_a) {
	var _b, _c
	var item = _a.item,
		installedServers = _a.installedServers
	var isInstalled = installedServers.some(function (server) {
		return server.name === item.mcpId
	})
	var _d = (0, react_1.useState)(false),
		isDownloading = _d[0],
		setIsDownloading = _d[1]
	...
	var githubAuthorUrl = (0, react_1.useMemo)(
		function () {
						...
						<div
							...
							<div
								...
								<span style={{ wordBreak: "break-all" }}>
									{(_c = (_b = item.githubStars) === null || _b === void 0 ? void 0 : _b.toLocaleString()) !==
										null && _c !== void 0
										? _c
										: 0}
								</span>
...
var StyledInstallButton = styled_components_1.default.button(
	templateObject_1 ||
