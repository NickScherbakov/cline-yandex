		...
		<div
			...
			<div
				...
				{serverName && autoApprovalSettings.enabled && autoApprovalSettings.actions.useMcp && (
					<react_1.VSCodeCheckbox checked={tool.autoApprove} onChange={handleAutoApproveChange} data-tool={tool.name}>
						Auto-approve
			...
			{tool.inputSchema && "properties" in tool.inputSchema && Object.keys(tool.inputSchema.properties).length > 0 && (
				<div
					style={{
						marginTop: "8px",
						fontSize: "12px",
