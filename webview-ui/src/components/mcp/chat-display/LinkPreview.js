			...
			<div
				...
				{data.image && (
					<div className="link-preview-image" style={{ width: "128px", height: "128px", flexShrink: 0 }}>
						<img
							src={dompurify_1.default.sanitize((0, mcpRichUtil_1.normalizeRelativeUrl)(data.image, url))}
							alt=""
							style={{
								width: "100%",
								height: "100%",
...
var MemoizedLinkPreview = react_1.default.memo(
	function (props) {
...
var LinkPreviewWithErrorBoundary = function (props) {
	return (
		<ChatErrorBoundary_1.default errorTitle="Something went wrong displaying this link preview">
