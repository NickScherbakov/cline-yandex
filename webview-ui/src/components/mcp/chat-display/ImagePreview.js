...
var ImagePreview = /** @class */ (function (_super) {
	...
	ImagePreview.prototype.render = function () {
		...
		var _a = this.state,
			loading = _a.loading,
			error = _a.error,
			fetchStartTime = _a.fetchStartTime
			...
			return (
				<div
					...
					{/\.svg(\?.*)?$/i.test(url) ? (
						<object
							type="image/svg+xml"
							data={dompurify_1.default.sanitize(url)}
							style={{ display: "none" }}
						...
						<img
							src={dompurify_1.default.sanitize(url)}
							alt=""
							ref={this.imgRef}
							onLoad={this.handleImageLoad}
							onError={this.handleImageError}
			...
			<div
				...
				{/\.svg(\?.*)?$/i.test(url) ? (
					...
					<object
						...
						<img
							src={dompurify_1.default.sanitize(url)}
							alt={"SVG from ".concat((0, mcpRichUtil_1.getSafeHostname)(url))}
							style={{
								width: "85%",
								height: "auto",
								borderRadius: "4px",
					...
					<img
						src={dompurify_1.default.sanitize(url)}
						alt={"Image from ".concat((0, mcpRichUtil_1.getSafeHostname)(url))}
						style={{
							width: "85%",
							height: "auto",
							borderRadius: "4px",
...
var MemoizedImagePreview = react_1.default.memo(
	function (props) {
...
var ImagePreviewWithErrorBoundary = function (props) {
	return (
		<ChatErrorBoundary_1.default errorTitle="Something went wrong displaying this image">
