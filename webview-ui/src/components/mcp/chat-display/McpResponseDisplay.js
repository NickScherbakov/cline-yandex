...
exports.MAX_URLS = 50;
var ResponseHeader = styled_components_1.default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n\tdisplay: flex;\n\tjustify-content: space-between;\n\talign-items: center;\n\tpadding: 9px 10px;\n\tcolor: var(--vscode-descriptionForeground);\n\tcursor: pointer;\n\tuser-select: none;\n\tborder-bottom: 1px dashed var(--vscode-editorGroup-border);\n\tmargin-bottom: 8px;\n\n\t.header-title {\n\t\tdisplay: flex;\n\t\talign-items: center;\n\t\twhite-space: nowrap;\n\t\toverflow: hidden;\n\t\ttext-overflow: ellipsis;\n\t\tmargin-right: 8px;\n\t}\n"], ["\n\tdisplay: flex;\n\tjustify-content: space-between;\n\talign-items: center;\n\tpadding: 9px 10px;\n\tcolor: var(--vscode-descriptionForeground);\n\tcursor: pointer;\n\tuser-select: none;\n\tborder-bottom: 1px dashed var(--vscode-editorGroup-border);\n\tmargin-bottom: 8px;\n\n\t.header-title {\n\t\tdisplay: flex;\n\t\talign-items: center;\n\t\twhite-space: nowrap;\n\t\toverflow: hidden;\n\t\ttext-overflow: ellipsis;\n\t\tmargin-right: 8px;\n\t}\n"])));
var ToggleSwitch = styled_components_1.default.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n\tdisplay: flex;\n\talign-items: center;\n\tfont-size: 12px;\n\tcolor: var(--vscode-descriptionForeground);\n\n\t.toggle-label {\n\t\tmargin-right: 8px;\n\t}\n\n\t.toggle-container {\n\t\tposition: relative;\n\t\twidth: 40px;\n\t\theight: 20px;\n\t\tbackground-color: var(--vscode-button-secondaryBackground);\n\t\tborder-radius: 10px;\n\t\tcursor: pointer;\n\t\ttransition: background-color 0.3s;\n\t}\n\n\t.toggle-container.active {\n\t\tbackground-color: var(--vscode-button-background);\n\t}\n\n\t.toggle-handle {\n\t\tposition: absolute;\n\t\ttop: 2px;\n\t\tleft: 2px;\n\t\twidth: 16px;\n\t\theight: 16px;\n\t\tbackground-color: var(--vscode-button-foreground);\n\t\tborder-radius: 50%;\n\t\ttransition: transform 0.3s;\n\t}\n\n\t.toggle-container.active .toggle-handle {\n\t\ttransform: translateX(20px);\n\t}\n"], ["\n\tdisplay: flex;\n\talign-items: center;\n\tfont-size: 12px;\n\tcolor: var(--vscode-descriptionForeground);\n\n\t.toggle-label {\n\t\tmargin-right: 8px;\n\t}\n\n\t.toggle-container {\n\t\tposition: relative;\n\t\twidth: 40px;\n\t\theight: 20px;\n\t\tbackground-color: var(--vscode-button-secondaryBackground);\n\t\tborder-radius: 10px;\n\t\tcursor: pointer;\n\t\ttransition: background-color 0.3s;\n\t}\n\n\t.toggle-container.active {\n\t\tbackground-color: var(--vscode-button-background);\n\t}\n\n\t.toggle-handle {\n\t\tposition: absolute;\n\t\ttop: 2px;\n\t\tleft: 2px;\n\t\twidth: 16px;\n\t\theight: 16px;\n\t\tbackground-color: var(--vscode-button-foreground);\n\t\tborder-radius: 50%;\n\t\ttransition: transform 0.3s;\n\t}\n\n\t.toggle-container.active .toggle-handle {\n\t\ttransform: translateX(20px);\n\t}\n"])));
var ResponseContainer = styled_components_1.default.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n\tposition: relative;\n\tfont-family: var(--vscode-editor-font-family, monospace);\n\tfont-size: var(--vscode-editor-font-size, 12px);\n\tbackground-color: ", ";\n\tcolor: var(--vscode-editor-foreground, #d4d4d4);\n\tborder-radius: 3px;\n\tborder: 1px solid var(--vscode-editorGroup-border);\n\toverflow: hidden;\n\n\t.response-content {\n\t\toverflow-x: auto;\n\t\toverflow-y: hidden;\n\t\tmax-width: 100%;\n\t\tpadding: 10px;\n\t}\n"], ["\n\tposition: relative;\n\tfont-family: var(--vscode-editor-font-family, monospace);\n\tfont-size: var(--vscode-editor-font-size, 12px);\n\tbackground-color: ", ";\n\tcolor: var(--vscode-editor-foreground, #d4d4d4);\n\tborder-radius: 3px;\n\tborder: 1px solid var(--vscode-editorGroup-border);\n\toverflow: hidden;\n\n\t.response-content {\n\t\toverflow-x: auto;\n\t\toverflow-y: hidden;\n\t\tmax-width: 100%;\n\t\tpadding: 10px;\n\t}\n"
    // Style for URL text to ensure proper wrapping
])), CodeBlock_1.CODE_BLOCK_BG_COLOR);
// Style for URL text to ensure proper wrapping
var UrlText = styled_components_1.default.div(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n\twhite-space: pre-wrap;\n\tword-break: break-all;\n\toverflow-wrap: break-word;\n\tfont-family: var(--vscode-editor-font-family, monospace);\n\tfont-size: var(--vscode-editor-font-size, 12px);\n"], ["\n\twhite-space: pre-wrap;\n\tword-break: break-all;\n\toverflow-wrap: break-word;\n\tfont-family: var(--vscode-editor-font-family, monospace);\n\tfont-size: var(--vscode-editor-font-size, 12px);\n"])));
var McpResponseDisplay = function (_a) {
    ...
    }), displayMode = _c[0], setDisplayMode = _c[1];
    var _d = (0, react_1.useState)([]), urlMatches = _d[0], setUrlMatches = _d[1];
    var _e = (0, react_1.useState)(null), error = _e[0], setError = _e[1];
    // Add a counter state for forcing re-renders to make toggling run smoother
    var _f = (0, react_1.useState)(0), forceUpdateCounter = _f[0], setForceUpdateCounter = _f[1];
    var toggleDisplayMode = (0, react_1.useCallback)(function () {
        var newMode = displayMode === "rich" ? "plain" : "rich";
        // Force an immediate re-render
        setForceUpdateCounter(function (prev) { return prev + 1; });
    ...
    (0, react_1.useEffect)(function () {
        ...
        var processResponse = function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                try {
                    ...
                    setUrlMatches(matches_1.sort(function (a, b) { return a.index - b.index; }));
                    // Mark loading as complete to show content immediately
                    setIsLoading(false);
                    processImageChecks = function () { return __awaiter(void 0, void 0, void 0, function () {
                        var i, match, isImage, err_1;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    console.log("Starting sequential URL processing for ".concat(matches_1.length, " URLs"));
                                    i = 0;
                                    _a.label = 1;
                                case 1:
                                    if (!(i < matches_1.length)) return [3 /*break*/, 8];
                                    // Skip already processed URLs (from extension check)
                                    if (matches_1[i].isProcessed)
                                        return [3 /*break*/, 7];
                                    ...
                                    match = matches_1[i];
                                    console.log("Processing URL ".concat(i + 1, " of ").concat(matches_1.length, ": ").concat(match.url));
                                    _a.label = 2;
                                case 2:
                                    _a.trys.push([2, 4, , 5]);
                                    return [4 /*yield*/, (0, mcpRichUtil_1.checkIfImageUrl)(match.url)
                                ...
                                case 7:
                                    ...
                                    return [3 /*break*/, 1];
                                case 8:
                                    console.log("URL processing complete. Found ".concat(matches_1.filter(function (m) { return m.isImage; }).length, " image URLs"));
                                    return [2 /*return*/];
                            }
                        });
                    }); };
        ...
        if (!isLoading) {
            ...
            if (urlMatches.length === 0) {
                ...
                for (var i = 0; i < urlMatches.length; i++) {
                    ...
                    var url = match.url, fullMatch = match.fullMatch, index = match.index;
                    // Add text segment before this URL
                    if (index > lastIndex) {
                        segments.push(<UrlText key={"segment-".concat(segmentIndex++)}>{responseText.substring(lastIndex, index)}</UrlText>);
                    }
                    ...
                    if (match.isImage) {
                        segments.push(<div key={"embed-image-".concat(url, "-").concat(segmentIndex++)}>
                        ...
                        try {
                            ...
                            if (!(0, mcpRichUtil_1.isLocalhostUrl)(url)) {
                                ...
                                segments.push(<div key={"embed-".concat(url, "-").concat(segmentIndex++)} style={{ margin: "10px 0" }}>
                            ...
                            segments.push(<div key={"embed-error-".concat(segmentIndex++)} style={{
                                    margin: "10px 0",
                                    padding: "8px",
        ...
        return (<ResponseContainer>
				<ResponseHeader>
					...
					<ToggleSwitch>
						...
						<div className={"toggle-container ".concat(displayMode === "rich" ? "active" : "")} onClick={toggleDisplayMode}>
...
var McpResponseDisplayWithErrorBoundary = function (props) {
    return (<ChatErrorBoundary_1.default>
