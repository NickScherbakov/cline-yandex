...
var WelcomeView = (0, react_2.memo)(function () {
    ...
    var _a = (0, react_2.useState)(undefined), apiErrorMessage = _a[0], setApiErrorMessage = _a[1];
    var _b = (0, react_2.useState)(false), showApiOptions = _b[0], setShowApiOptions = _b[1];
    ...
    return (<div className="fixed inset-0 p-0 flex flex-col">
			<div className="h-full px-5 overflow-auto">
				...
				{!showApiOptions && (<react_1.VSCodeButton appearance="secondary" onClick={function () { return setShowApiOptions(!showApiOptions); }} className="mt-2.5 w-full">
