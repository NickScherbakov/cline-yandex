...
var HistoryView = function (_a) {
	...
	var _b = (0, ExtensionStateContext_1.useExtensionState)(),
		...
		totalTasksSize = _b.totalTasksSize
	var _c = (0, react_2.useState)(""),
		searchQuery = _c[0],
		setSearchQuery = _c[1]
	var _d = (0, react_2.useState)("newest"),
		sortOption = _d[0],
		setSortOption = _d[1]
	var _e = (0, react_2.useState)("newest"),
		lastNonRelevantSort = _e[0],
		setLastNonRelevantSort = _e[1]
	var _f = (0, react_2.useState)(false),
		deleteAllDisabled = _f[0],
		setDeleteAllDisabled = _f[1]
	...
	var presentableTasks = (0, react_2.useMemo)(
		function () {
			return taskHistory.filter(function (item) {
				return item.ts && item.task
			})
		},
		[taskHistory],
	)
	...
	var taskHistorySearchResults = (0, react_2.useMemo)(
		function () {
            ...
            <div
                ...
                <div>Start a task to see it here</div>
					...
					<react_virtuoso_1.Virtuoso
						...
						itemContent={function (index, item) {
							var _a
							return (
								<div
									key={item.id}
									...
									onClick={function () {
										return handleHistorySelect(item.id)
									}}>
									<div
										style={{
											display: "flex",
												...
												<div
													...
													<div
														...
														<span
															...
															$
															{(_a = item.totalCost) === null || _a === void 0
																? void 0
																: _a.toFixed(4)}
														</span>
													</div>
				...
				<div
					...
					<DangerButton_1.default
						...
						Delete All History
						{totalTasksSize !== null ? " (".concat((0, format_2.formatSize)(totalTasksSize), ")") : ""}
					</DangerButton_1.default>
				</div>
			</div>
		</>
