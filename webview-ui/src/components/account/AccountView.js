...
var ClineAccountView = function () {
	var _a, _b
	var _c = (0, FirebaseAuthContext_1.useFirebaseAuth)(),
		firebaseUser = _c.user,
		handleSignOut = _c.handleSignOut
	var _d = (0, ExtensionStateContext_1.useExtensionState)(),
		userInfo = _d.userInfo,
		apiConfiguration = _d.apiConfiguration
	...
	var _e = (0, react_2.useState)(0),
		balance = _e[0],
		setBalance = _e[1]
	var _f = (0, react_2.useState)(true),
		isLoading = _f[0],
		setIsLoading = _f[1]
			...
			{user ? (
						...
						<div className="flex items-center mb-6 flex-wrap gap-y-4">
							{user.photoURL ? (
								...
								<div className="size-16 rounded-full bg-[var(--vscode-button-background)] flex items-center justify-center text-2xl text-[var(--vscode-button-foreground)] mr-4">
									{((_a = user.displayName) === null || _a === void 0 ? void 0 : _a[0]) ||
										((_b = user.email) === null || _b === void 0 ? void 0 : _b[0]) ||
										"?"}
								</div>
							)}
							...
							{isLoading ? (
								...
								<>
									...
									<react_1.VSCodeButton
										...
										className="mt-1"
										onClick={function () {
											return vscode_1.vscode.postMessage({ type: "fetchUserCreditsData" })
										}}>
				...
				<div className="flex flex-col items-center pr-3">
					...
					<p className="text-[var(--vscode-descriptionForeground)] text-xs text-center m-0">
						...
						<react_1.VSCodeLink href="https://cline.bot/tos">Terms of Service</react_1.VSCodeLink> and{" "}
