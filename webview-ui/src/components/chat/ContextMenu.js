...
var ContextMenu = function (_a) {
    var onSelect = _a.onSelect, searchQuery = _a.searchQuery, onMouseDown = _a.onMouseDown, selectedIndex = _a.selectedIndex, setSelectedIndex = _a.setSelectedIndex, selectedType = _a.selectedType, queryItems = _a.queryItems, _b = _a.dynamicSearchResults, dynamicSearchResults = _b === void 0 ? [] : _b, _c = _a.isLoading, isLoading = _c === void 0 ? false : _c;
    var menuRef = (0, react_1.useRef)(null);
    // State to show delayed loading indicator
    var _d = (0, react_1.useState)(false), showDelayedLoading = _d[0], setShowDelayedLoading = _d[1];
    var loadingTimeoutRef = (0, react_1.useRef)(null);
    var filteredOptions = (0, react_1.useMemo)(function () {
        var options = (0, context_mentions_1.getContextMenuOptions)(searchQuery, selectedType, queryItems, dynamicSearchResults);
        return options;
    ...
    var isOptionSelectable = function (option) {
        return option.type !== context_mentions_1.ContextMenuOptionType.NoResults && option.type !== context_mentions_1.ContextMenuOptionType.URL;
    };
    return (<div style={{
            position: "absolute",
            ...
            overflowY: "auto",
				...
				{showDelayedLoading && searchQuery && (<div style={{
                padding: "8px 12px",
                display: "flex",
                alignItems: "center",
                gap: "8px",
				...
				{filteredOptions.map(function (option, index) { return (<div key={"".concat(option.type, "-").concat(option.value || index)} onClick={function () { return isOptionSelectable(option) && onSelect(option.type, option.value); }} style={{
                padding: "8px 12px",
                ...
                backgroundColor: index === selectedIndex && isOptionSelectable(option)
                    ...
                    : "",
            }} onMouseEnter={function () { return isOptionSelectable(option) && setSelectedIndex(index); }}>
						<div style={{
                display: "flex",
                alignItems: "center",
                flex: 1,
                ...
                overflow: "hidden",
							...
							<i className={"codicon codicon-".concat(getIconForOption(option))} style={{
                marginRight: "8px",
                flexShrink: 0,
                fontSize: "14px",
            }}/>
                ...
                !option.value && (<i className="codicon codicon-chevron-right" style={{
                    fontSize: "14px",
                    flexShrink: 0,
                    marginLeft: 8,
                }}/>)}
                ...
                ((option.type === context_mentions_1.ContextMenuOptionType.File ||
                    option.type === context_mentions_1.ContextMenuOptionType.Folder ||
                    option.type === context_mentions_1.ContextMenuOptionType.Git) &&
                    option.value)) && (<i className="codicon codicon-add" style={{
                    fontSize: "14px",
                    flexShrink: 0,
                    marginLeft: 8,
                }}/>)}
