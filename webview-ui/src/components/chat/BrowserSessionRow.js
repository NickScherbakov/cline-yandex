...
var BrowserSessionRow = (0, react_2.memo)(function (props) {
    var _a, _b;
    var messages = props.messages, isLast = props.isLast, onHeightChange = props.onHeightChange, lastModifiedMessage = props.lastModifiedMessage;
    var browserSettings = (0, ExtensionStateContext_1.useExtensionState)().browserSettings;
    var prevHeightRef = (0, react_2.useRef)(0);
    var _c = (0, react_2.useState)(0), maxActionHeight = _c[0], setMaxActionHeight = _c[1];
    var _d = (0, react_2.useState)(false), consoleLogsExpanded = _d[0], setConsoleLogsExpanded = _d[1];
    var isLastApiReqInterrupted = (0, react_2.useMemo)(function () {
        // Check if last api_req_started is cancelled
        var lastApiReqStarted = __spreadArray([], messages, true).reverse().find(function (m) { return m.say === "api_req_started"; });
        ...
        var lastApiReqFailed = isLast && (lastModifiedMessage === null || lastModifiedMessage === void 0 ? void 0 : lastModifiedMessage.ask) === "api_req_failed";
        if (lastApiReqFailed) {
            return true;
        }
        return false;
    }, [messages, lastModifiedMessage, isLast]);
    var isBrowsing = (0, react_2.useMemo)(function () {
        return isLast && messages.some(function (m) { return m.say === "browser_action_result"; }) && !isLastApiReqInterrupted; // after user approves, browser_action_result with "" is sent to indicate that the session has started
    }, [isLast, messages, isLastApiReqInterrupted]);
    // Organize messages into pages with current state and next action
    var pages = (0, react_2.useMemo)(function () {
        var result = [];
    ...
    var _e = (0, react_2.useState)(0), currentPageIndex = _e[0], setCurrentPageIndex = _e[1];
    (0, react_2.useEffect)(function () {
        setCurrentPageIndex(pages.length - 1);
    }, [pages.length]);
    // Get initial URL from launch message
    var initialUrl = (0, react_2.useMemo)(function () {
        var launchMessage = messages.find(function (m) { return m.ask === "browser_action_launch" || m.say === "browser_action_launch"; });
        return (launchMessage === null || launchMessage === void 0 ? void 0 : launchMessage.text) || "";
    }, [messages]);
    var isAutoApproved = (0, react_2.useMemo)(function () {
        var launchMessage = messages.find(function (m) { return m.ask === "browser_action_launch" || m.say === "browser_action_launch"; });
    ...
    var latestState = (0, react_2.useMemo)(function () {
    ...
    var displayState = isLastPage
        ? {
            url: (currentPage === null || currentPage === void 0 ? void 0 : currentPage.currentState.url) || latestState.url || initialUrl,
            mousePosition: (currentPage === null || currentPage === void 0 ? void 0 : currentPage.currentState.mousePosition) || latestState.mousePosition || defaultMousePosition,
            consoleLogs: currentPage === null || currentPage === void 0 ? void 0 : currentPage.currentState.consoleLogs,
            screenshot: (currentPage === null || currentPage === void 0 ? void 0 : currentPage.currentState.screenshot) || latestState.screenshot,
        }
        : {
            url: (currentPage === null || currentPage === void 0 ? void 0 : currentPage.currentState.url) || initialUrl,
            mousePosition: (currentPage === null || currentPage === void 0 ? void 0 : currentPage.currentState.mousePosition) || defaultMousePosition,
            consoleLogs: currentPage === null || currentPage === void 0 ? void 0 : currentPage.currentState.consoleLogs,
            screenshot: currentPage === null || currentPage === void 0 ? void 0 : currentPage.currentState.screenshot,
        };
    var _f = (0, react_use_1.useSize)(<div>
			{(_a = currentPage === null || currentPage === void 0 ? void 0 : currentPage.nextAction) === null || _a === void 0 ? void 0 : _a.messages.map(function (message) { return (<BrowserSessionRowContent key={message.ts} {...props} message={message} setMaxActionHeight={setMaxActionHeight}/>); })}
			{!isBrowsing && messages.some(function (m) { return m.say === "browser_action_result"; }) && currentPageIndex === 0 && (<BrowserActionBox action={"launch"} text={initialUrl}/>)}
		</div>), actionContent = _f[0], actionHeight = _f[1].height;
    (0, react_2.useEffect)(function () {
    ...
    var latestClickPosition = (0, react_2.useMemo)(function () {
        var _a;
        if (!isBrowsing)
            return undefined;
        // Look through current page's next actions for the latest browser_action
        var actions = ((_a = currentPage === null || currentPage === void 0 ? void 0 : currentPage.nextAction) === null || _a === void 0 ? void 0 : _a.messages) || [];
        ...
        return undefined;
    }, [isBrowsing, (_b = currentPage === null || currentPage === void 0 ? void 0 : currentPage.nextAction) === null || _b === void 0 ? void 0 : _b.messages]);
    ...
    // }
    var shouldShowSettings = (0, react_2.useMemo)(function () {
        var lastMessage = messages[messages.length - 1];
        return (lastMessage === null || lastMessage === void 0 ? void 0 : lastMessage.ask) === "browser_action_launch" || (lastMessage === null || lastMessage === void 0 ? void 0 : lastMessage.say) === "browser_action_launch";
    }, [messages]);
    // Calculate maxWidth
    var maxWidth = browserSettings.viewport.width < BrowserSettings_1.BROWSER_VIEWPORT_PRESETS["Small Desktop (900x600)"].width ? 200 : undefined;
    ...
    <BrowserSessionRowContainer style={{ marginBottom: -10 }}>
			<div style={browserSessionRowContainerInnerStyle}>
				{isBrowsing ? <ChatRow_1.ProgressIndicator /> : <span className="codicon codicon-inspect" style={browserIconStyle}></span>}
            ...
            fontSize: "12px",
				...
				<div style={{
            width: "100%",
            paddingBottom: "".concat((browserSettings.viewport.height / browserSettings.viewport.width) * 100, "%"),
            position: "relative",
            backgroundColor: "var(--vscode-input-background)",
        }}>
					{displayState.screenshot ? (<img src={displayState.screenshot} alt="Browser screenshot" style={imgScreenshotStyle} onClick={function () {
                return vscode_1.vscode.postMessage({
					...
					{displayState.mousePosition && (<BrowserCursor style={{
                position: "absolute",
                top: "".concat((parseInt(mousePosition.split(",")[1]) / browserSettings.viewport.height) * 100, "%"),
                left: "".concat((parseInt(mousePosition.split(",")[0]) / browserSettings.viewport.width) * 100, "%"),
            ...
            padding: "9px 8px ".concat(consoleLogsExpanded ? 0 : 8, "px 8px"),
					...
					{consoleLogsExpanded && (<CodeBlock_1.default source={"".concat("```", "shell\n").concat(displayState.consoleLogs || "(No new logs)", "\n").concat("```")}/>)}
				</div>
			</div>
			...
			{pages.length > 1 && (<div style={paginationContainerStyle}>
					<div>
						Step {currentPageIndex + 1} of {pages.length}
					</div>
					<div style={paginationButtonGroupStyle}>
						<react_1.VSCodeButton disabled={currentPageIndex === 0 || isBrowsing} onClick={function () { return setCurrentPageIndex(function (i) { return i - 1; }); }}>
							Previous
						</react_1.VSCodeButton>
						<react_1.VSCodeButton disabled={currentPageIndex === pages.length - 1 || isBrowsing} onClick={function () { return setCurrentPageIndex(function (i) { return i + 1; }); }}>
							Next
						</react_1.VSCodeButton>
					</div>
				</div>)}
		...
		</BrowserSessionRowContainer>), browserSessionRow = _g[0], height = _g[1].height;
...
var BrowserSessionRowContent = function (_a) {
    var message = _a.message, isExpanded = _a.isExpanded, onToggleExpand = _a.onToggleExpand, lastModifiedMessage = _a.lastModifiedMessage, isLast = _a.isLast, setMaxActionHeight = _a.setMaxActionHeight;
    if (message.ask === "browser_action_launch" || message.say === "browser_action_launch") {
        return (<>
    ...
    switch (message.type) {
        case "say":
            switch (message.say) {
                ...
                case "text":
                    return (<div style={chatRowContentContainerStyle}>
							<ChatRow_1.ChatRowContent message={message} isExpanded={isExpanded(message.ts)} onToggleExpand={function () {
                            if (message.say === "api_req_started") {
                                setMaxActionHeight(0);
                            }
                            onToggleExpand(message.ts);
                        }} lastModifiedMessage={lastModifiedMessage} isLast={isLast}/>
						</div>);
                case "browser_action":
                    var browserAction = JSON.parse(message.text || "{}");
                    return (<BrowserActionBox action={browserAction.action} coordinate={browserAction.coordinate} text={browserAction.text}/>);
                default:
                    return null;
            }
        case "ask":
...
var BrowserActionBox = function (_a) {
    var action = _a.action, coordinate = _a.coordinate, text = _a.text;
    var getBrowserActionText = function (action, coordinate, text) {
        switch (action) {
            case "launch":
                return "Launch browser at ".concat(text);
            case "click":
                return "Click (".concat(coordinate === null || coordinate === void 0 ? void 0 : coordinate.replace(",", ", "), ")");
            case "type":
    ...
    return (<div style={browserActionBoxContainerStyle}>
...
var BrowserSessionRowContainer = styled_components_1.default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n\tpadding: 10px 6px 10px 15px;\n\tposition: relative;\n\n\t&:hover ", " {\n\t\topacity: 1;\n\t}\n"], ["\n\tpadding: 10px 6px 10px 15px;\n\tposition: relative;\n\n\t&:hover ", " {\n\t\topacity: 1;\n\t}\n"])), CheckpointControls_1.CheckpointControls);
