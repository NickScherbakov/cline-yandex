...
var ChatView = function (_a) {
	var isHidden = _a.isHidden,
		showAnnouncement = _a.showAnnouncement,
		hideAnnouncement = _a.hideAnnouncement,
		showHistoryView = _a.showHistoryView
	var _b = (0, ExtensionStateContext_1.useExtensionState)(),
		version = _b.version,
		messages = _b.clineMessages,
		taskHistory = _b.taskHistory,
		apiConfiguration = _b.apiConfiguration,
		telemetrySetting = _b.telemetrySetting
	//const task = messages.length > 0 ? (messages[0].say === "task" ? messages[0] : undefined) : undefined) : undefined
	var task = (0, react_2.useMemo)(
		function () {
			return messages.at(0)
		},
		[messages],
	) // leaving this less safe version here since if the first message is not a task, then the extension is in a bad state and needs to be debugged (see Cline.abort)
	var modifiedMessages = (0, react_2.useMemo)(
		function () {
	...
	var apiMetrics = (0, react_2.useMemo)(
		function () {
			return (0, getApiMetrics_1.getApiMetrics)(modifiedMessages)
		},
		[modifiedMessages],
	)
	var lastApiReqTotalTokens = (0, react_2.useMemo)(
		function () {
			var getTotalTokensFromApiReqMessage = function (msg) {
				if (!msg.text) return 0
				var _a = JSON.parse(msg.text),
					tokensIn = _a.tokensIn,
					tokensOut = _a.tokensOut,
					cacheWrites = _a.cacheWrites,
					cacheReads = _a.cacheReads
	...
	var _d = (0, react_2.useState)(false),
		textAreaDisabled = _d[0],
		setTextAreaDisabled = _d[1]
	var _e = (0, react_2.useState)([]),
		selectedImages = _e[0],
		setSelectedImages = _e[1]
	...
	var _g = (0, react_2.useState)(false),
		enableButtons = _g[0],
		setEnableButtons = _g[1]
	var _h = (0, react_2.useState)("Approve"),
		primaryButtonText = _h[0],
		setPrimaryButtonText = _h[1]
	var _j = (0, react_2.useState)("Reject"),
		secondaryButtonText = _j[0],
		setSecondaryButtonText = _j[1]
	var _k = (0, react_2.useState)(false),
		didClickCancel = _k[0],
		setDidClickCancel = _k[1]
	var virtuosoRef = (0, react_2.useRef)(null)
	var _l = (0, react_2.useState)({}),
		expandedRows = _l[0],
		setExpandedRows = _l[1]
	var scrollContainerRef = (0, react_2.useRef)(null)
	var disableAutoScrollRef = (0, react_2.useRef)(false)
	var _m = (0, react_2.useState)(false),
		showScrollToBottom = _m[0],
		setShowScrollToBottom = _m[1]
	var _o = (0, react_2.useState)(false),
		isAtBottom = _o[0],
		setIsAtBottom = _o[1]
	// UI layout depends on the last 2 messages
	// (since it relies on the content of these messages, we are deep comparing. i.e. the button state after hitting button sets enableButtons to false, and this effect otherwise would have to true again even if messages didn't change
	var lastMessage = (0, react_2.useMemo)(
		function () {
			return messages.at(-1)
		},
		[messages],
	)
	var secondLastMessage = (0, react_2.useMemo)(
		function () {
					...
					case "say":
						...
						switch (lastMessage.say) {
							case "api_req_started":
								if (
									(secondLastMessage === null || secondLastMessage === void 0
										? void 0
	...
	var isStreaming = (0, react_2.useMemo)(
		function () {
			var _a, _b
			...
			if (isLastMessagePartial) {
				...
				var lastApiReqStarted = (0, array_1.findLast)(modifiedMessages, function (message) {
	...
	var handleSendMessage = (0, react_2.useCallback)(
		function (text, images) {
			text = text.trim()
    ...
    */
	var handlePrimaryButtonClick = (0, react_2.useCallback)(
		function (text, images) {
	...
	var handleSecondaryButtonClick = (0, react_2.useCallback)(
		function (text, images) {
			var trimmedInput = text === null || text === void 0 ? void 0 : text.trim()
			if (isStreaming) {
	...
	var handleTaskCloseButtonClick = (0, react_2.useCallback)(
		function () {
			startNewTask()
		},
		[startNewTask],
	)
	var selectedModelInfo = (0, react_2.useMemo)(
		function () {
	...
	var shouldDisableImages =
		!selectedModelInfo.supportsImages || textAreaDisabled || selectedImages.length >= exports.MAX_IMAGES_PER_MESSAGE
	var handleMessage = (0, react_2.useCallback)(
		function (e) {
			...
			switch (message.type) {
				...
				case "selectedImages":
					...
					if (newImages_1.length > 0) {
						setSelectedImages(function (prevImages) {
							return __spreadArray(__spreadArray([], prevImages, true), newImages_1, true).slice(
								0,
								exports.MAX_IMAGES_PER_MESSAGE,
							)
						})
					}
					break
				...
				case "invoke":
					switch (message.invoke) {
						case "sendMessage":
							handleSendMessage(
								(_c = message.text) !== null && _c !== void 0 ? _c : "",
								(_d = message.images) !== null && _d !== void 0 ? _d : [],
							)
							break
						case "primaryButtonClick":
							handlePrimaryButtonClick(
								(_e = message.text) !== null && _e !== void 0 ? _e : "",
								(_f = message.images) !== null && _f !== void 0 ? _f : [],
							)
							break
						case "secondaryButtonClick":
							handleSecondaryButtonClick(
								(_g = message.text) !== null && _g !== void 0 ? _g : "",
								(_h = message.images) !== null && _h !== void 0 ? _h : [],
							)
							break
					}
			}
	...
	var visibleMessages = (0, react_2.useMemo)(
		function () {
			return modifiedMessages.filter(function (message) {
				...
				switch (message.say) {
					...
					case "text":
						...
						if (
							((_a = message.text) !== null && _a !== void 0 ? _a : "") === "" &&
							((_c = (_b = message.images) === null || _b === void 0 ? void 0 : _b.length) !== null && _c !== void 0
								? _c
								: 0) === 0
						) {
							return false
	...
	var groupedMessages = (0, react_2.useMemo)(
		function () {
			var result = []
			var currentGroup = []
			...
			visibleMessages.forEach(function (message) {
				if (message.ask === "browser_action_launch" || message.say === "browser_action_launch") {
					...
					if (message.say === "api_req_started") {
						...
						var lastApiReqStarted = __spreadArray([], currentGroup, true)
							.reverse()
							.find(function (m) {
								return m.say === "api_req_started"
							})
						if (
							(lastApiReqStarted === null || lastApiReqStarted === void 0 ? void 0 : lastApiReqStarted.text) != null
						) {
	...
	var scrollToBottomSmooth = (0, react_2.useMemo)(function () {
		return (0, debounce_1.default)(
			function () {
				var _a
				;(_a = virtuosoRef.current) === null || _a === void 0
					? void 0
					: _a.scrollTo({
	...
	var toggleRowExpansion = (0, react_2.useCallback)(
		function (ts) {
			var _a
			var isCollapsing = (_a = expandedRows[ts]) !== null && _a !== void 0 ? _a : false
			var lastGroup = groupedMessages.at(-1)
			var isLast = Array.isArray(lastGroup)
				? lastGroup[0].ts === ts
				: (lastGroup === null || lastGroup === void 0 ? void 0 : lastGroup.ts) === ts
	...
	var handleRowHeightChange = (0, react_2.useCallback)(
		function (isTaller) {
	...
	var placeholderText = (0, react_2.useMemo)(
		function () {
	...
	var itemContent = (0, react_2.useCallback)(
		function (index, messageOrGroup) {
			// browser session group
			if (Array.isArray(messageOrGroup)) {
				return (
					<BrowserSessionRow_1.default
						messages={messageOrGroup}
						isLast={index === groupedMessages.length - 1}
						lastModifiedMessage={modifiedMessages.at(-1)}
						onHeightChange={handleRowHeightChange}
						// Pass handlers for each message in the group
						isExpanded={function (messageTs) {
							var _a
							return (_a = expandedRows[messageTs]) !== null && _a !== void 0 ? _a : false
						}}
						onToggleExpand={function (messageTs) {
							setExpandedRows(function (prev) {
								var _a
			...
			return (
				<ChatRow_1.default
					...
					onToggleExpand={function () {
						return toggleRowExpansion(messageOrGroup.ts)
					}}
					lastModifiedMessage={modifiedMessages.at(-1)}
					isLast={index === groupedMessages.length - 1}
					onHeightChange={handleRowHeightChange}
	...
	return (
        ...
        */}
						...
						<div
							...
							{primaryButtonText && !isStreaming && (
								<react_1.VSCodeButton
									...
									onClick={function () {
										return handlePrimaryButtonClick(inputValue, selectedImages)
									}}>
									{primaryButtonText}
								</react_1.VSCodeButton>
							)}
							{(secondaryButtonText || isStreaming) && (
								<react_1.VSCodeButton
									...
									onClick={function () {
										return handleSecondaryButtonClick(inputValue, selectedImages)
									}}>
			...
			<ChatTextArea_1.default
				...
				onSend={function () {
					return handleSendMessage(inputValue, selectedImages)
				}}
...
var ScrollToBottomButton = styled_components_1.default.div(
	templateObject_1 ||
