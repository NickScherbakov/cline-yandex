...
var TaskHeader = function (_a) {
	var task = _a.task,
		...
		doesModelSupportPromptCache = _a.doesModelSupportPromptCache,
		cacheWrites = _a.cacheWrites,
		cacheReads = _a.cacheReads,
		totalCost = _a.totalCost,
		lastApiReqTotalTokens = _a.lastApiReqTotalTokens,
		onClose = _a.onClose
	var _b = (0, ExtensionStateContext_1.useExtensionState)(),
		apiConfiguration = _b.apiConfiguration,
		currentTaskItem = _b.currentTaskItem,
		checkpointTrackerErrorMessage = _b.checkpointTrackerErrorMessage
	var _c = (0, react_2.useState)(false),
		isTaskExpanded = _c[0],
		setIsTaskExpanded = _c[1]
	var _d = (0, react_2.useState)(false),
		isTextExpanded = _d[0],
		setIsTextExpanded = _d[1]
    ...
    After:
    */
	var _f = (0, react_use_1.useWindowSize)(),
		windowHeight = _f.height,
		windowWidth = _f.width
	;(0, react_2.useEffect)(
		function () {
	...
	var isCostAvailable = (0, react_2.useMemo)(
		function () {
			var _a, _b
			var openAiCompatHasPricing =
				(apiConfiguration === null || apiConfiguration === void 0 ? void 0 : apiConfiguration.apiProvider) === "openai" &&
				((_a = apiConfiguration === null || apiConfiguration === void 0 ? void 0 : apiConfiguration.openAiModelInfo) ===
					null || _a === void 0
					? void 0
					: _a.inputPrice) &&
				((_b = apiConfiguration === null || apiConfiguration === void 0 ? void 0 : apiConfiguration.openAiModelInfo) ===
					null || _b === void 0
					? void 0
					: _b.outputPrice)
			...
			return (
				(apiConfiguration === null || apiConfiguration === void 0 ? void 0 : apiConfiguration.apiProvider) !==
					"vscode-lm" &&
	...
	var shouldShowPromptCacheInfo =
		doesModelSupportPromptCache &&
		(apiConfiguration === null || apiConfiguration === void 0 ? void 0 : apiConfiguration.apiProvider) !== "openrouter" &&
		(apiConfiguration === null || apiConfiguration === void 0 ? void 0 : apiConfiguration.apiProvider) !== "cline"
			...
			<div
				...
				<div
					...
					<div
						...
						onClick={function () {
							return setIsTaskExpanded(!isTaskExpanded)
						}}>
						<div
							style={{
								display: "flex",
						...
						<div
							...
							{!isTaskExpanded && (
								<span style={{ marginLeft: 4 }}>{(0, exports.highlightMentions)(task.text, false)}</span>
							)}
						</div>
					</div>
					...
					<>
							...
							{!isTextExpanded && showSeeMore && (
								<div
									...
									<div
										...
										onClick={function () {
											return setIsTextExpanded(!isTextExpanded)
										}}>
										See more
									</div>
								</div>
						...
						<div
							...
							<div
								...
								{!isCostAvailable && (
									<DeleteButton
										taskSize={(0, format_2.formatSize)(
											currentTaskItem === null || currentTaskItem === void 0
												? void 0
												: currentTaskItem.size,
										)}
										taskId={
											currentTaskItem === null || currentTaskItem === void 0 ? void 0 : currentTaskItem.id
										}
									/>
								)}
							</div>
		...
		if (index % 2 === 0) {
			...
			return (
				<span
					...
					onClick={function () {
						return vscode_1.vscode.postMessage({ type: "openMention", text: part })
					}}>
					@{part}
				</span>
			)
...
var DeleteButton = function (_a) {
	var taskSize = _a.taskSize,
		taskId = _a.taskId
	return (
		<react_1.VSCodeButton
			appearance="icon"
			onClick={function () {
				return vscode_1.vscode.postMessage({ type: "deleteTaskWithId", text: taskId })
			}}
