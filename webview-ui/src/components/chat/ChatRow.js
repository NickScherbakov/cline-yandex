...
var ChatRowContainer = styled_components_1.default.div(
	templateObject_1 ||
...
var ChatRowContent = function (_a) {
	...
	var message = _a.message,
		...
		isLast = _a.isLast
	var _p = (0, ExtensionStateContext_1.useExtensionState)(),
		mcpServers = _p.mcpServers,
		mcpMarketplaceCatalog = _p.mcpMarketplaceCatalog
	var _q = (0, react_2.useState)(false),
		seeNewChangesDisabled = _q[0],
		setSeeNewChangesDisabled = _q[1]
	var _r = (0, react_2.useMemo)(
			function () {
		...
		cost = _r[0],
		apiReqCancelReason = _r[1],
		apiReqStreamingFailedMessage = _r[2]
	// when resuming task last won't be api_req_failed but a resume_task message so api_req_started will show loading spinner. that's why we just remove the last api_req_started that failed without streaming anything
	var apiRequestFailedMessage =
		isLast &&
		(lastModifiedMessage === null || lastModifiedMessage === void 0 ? void 0 : lastModifiedMessage.ask) === "api_req_failed" // if request is retried then the latest message is a api_req_retried
			? lastModifiedMessage === null || lastModifiedMessage === void 0
				? void 0
				: lastModifiedMessage.text
			: undefined
	var isCommandExecuting =
		isLast &&
		((lastModifiedMessage === null || lastModifiedMessage === void 0 ? void 0 : lastModifiedMessage.ask) === "command" ||
			(lastModifiedMessage === null || lastModifiedMessage === void 0 ? void 0 : lastModifiedMessage.say) === "command") &&
		((_b = lastModifiedMessage === null || lastModifiedMessage === void 0 ? void 0 : lastModifiedMessage.text) === null ||
		_b === void 0
			? void 0
			: _b.includes(combineCommandSequences_1.COMMAND_OUTPUT_STRING))
	var isMcpServerResponding =
		isLast &&
		(lastModifiedMessage === null || lastModifiedMessage === void 0 ? void 0 : lastModifiedMessage.say) ===
			...
			function () {
				switch (type) {
					...
					case "api_req_started":
						var getIconSpan = function (iconName, color) {
							return (
								<div
									style={{
										width: 16,
									...
									<span
										className={"codicon codicon-".concat(iconName)}
										style={{
											color: color,
											fontSize: 16,
											marginBottom: "-1.5px",
	...
	if (tool) {
		var toolIcon = function (name) {
			return (
				<span
					className={"codicon codicon-".concat(name)}
					style={{
			...
			case "searchFiles":
				return (
					<>
						...
						<CodeAccordian_1.default
							code={tool.content}
							path={tool.path + (tool.filePattern ? "/(".concat(tool.filePattern, ")") : "")}
							language="plaintext"
							isExpanded={isExpanded}
							onToggleExpand={onToggleExpand}
						/>
	...
	if (message.ask === "command" || message.say === "command") {
		...
		var _t = splitMessage(message.text || ""),
			rawCommand = _t.command,
			output = _t.output
		var requestsApproval = rawCommand.endsWith(combineCommandSequences_1.COMMAND_REQ_APP_STRING)
		var command = requestsApproval
			? rawCommand.slice(0, -combineCommandSequences_1.COMMAND_REQ_APP_STRING.length)
			: rawCommand
		return (
			<>
				<div style={headerStyle}>
	...
	if (message.ask === "use_mcp_server" || message.say === "use_mcp_server") {
		...
		var server = mcpServers.find(function (server) {
			return server.name === useMcpServer_1.serverName
		})
		return (
			<>
				<div style={headerStyle}>
				...
				<div
					...
					{useMcpServer_1.type === "access_mcp_resource" && (
						<McpResourceRow_1.default
							item={__assign(
								__assign(
									{},
									(0, mcp_1.findMatchingResourceOrTemplate)(
										useMcpServer_1.uri || "",
										server === null || server === void 0 ? void 0 : server.resources,
										server === null || server === void 0 ? void 0 : server.resourceTemplates,
									) || {
										name: "",
										mimeType: "",
										description: "",
					...
					{useMcpServer_1.type === "use_mcp_tool" && (
						<>
							<div
								...
								<McpToolRow_1.default
									tool={{
										name: useMcpServer_1.toolName || "",
										description:
											((_f =
												(_e = server === null || server === void 0 ? void 0 : server.tools) === null ||
												_e === void 0
													? void 0
													: _e.find(function (tool) {
															return tool.name === useMcpServer_1.toolName
														})) === null || _f === void 0
												? void 0
												: _f.description) || "",
										autoApprove:
											((_h =
												(_g = server === null || server === void 0 ? void 0 : server.tools) === null ||
												_g === void 0
													? void 0
													: _g.find(function (tool) {
															return tool.name === useMcpServer_1.toolName
														})) === null || _h === void 0
												? void 0
												: _h.autoApprove) || false,
									}}
									serverName={useMcpServer_1.serverName}
								/>
							</div>
							{useMcpServer_1.arguments && useMcpServer_1.arguments !== "{}" && (
			...
			switch (message.say) {
				case "api_req_started":
					return (
						<>
							<div
								style={__assign(__assign({}, headerStyle), {
									marginBottom:
									...
									{(function () {
										...
										return (
											<p style={__assign(__assign({}, pStyle), { color: "var(--vscode-errorForeground)" })}>
												...
												{(apiRequestFailedMessage === null || apiRequestFailedMessage === void 0
													? void 0
					...
					return (
						<div
							...
							{message.images && message.images.length > 0 && (
								<Thumbnails_1.default images={message.images} style={{ marginTop: "8px" }} />
							)}
						</div>
					)
				...
				case "checkpoint_created":
					return (
						<>
							<CheckmarkControl_1.CheckmarkControl
				...
				case "completion_result":
					var hasChanges =
						(_l =
							(_k = message.text) === null || _k === void 0
								? void 0
								: _k.endsWith(ExtensionMessage_1.COMPLETION_RESULT_CHANGES_FLAG)) !== null && _l !== void 0
							? _l
							: false
					var text = hasChanges
						? (_m = message.text) === null || _m === void 0
							? void 0
							: _m.slice(0, -ExtensionMessage_1.COMPLETION_RESULT_CHANGES_FLAG.length)
						: message.text
					return (
						<>
		...
		case "ask":
			switch (message.ask) {
				...
				case "completion_result":
					if (message.text) {
						var hasChanges =
							(_o = message.text.endsWith(ExtensionMessage_1.COMPLETION_RESULT_CHANGES_FLAG)) !== null &&
							_o !== void 0
								? _o
								: false
						var text = hasChanges
							? message.text.slice(0, -ExtensionMessage_1.COMPLETION_RESULT_CHANGES_FLAG.length)
							: message.text
						return (
							<div>
								<div style={__assign(__assign({}, headerStyle), { marginBottom: "10px" })}>
					...
					return (
						<>
							...
							<div style={{ paddingTop: 10 }}>
								...
								<OptionsButtons_1.OptionsButtons
									options={options}
									selected={selected}
									isActive={
										isLast &&
										(lastModifiedMessage === null || lastModifiedMessage === void 0
											? void 0
											: lastModifiedMessage.ask) === "followup"
									}
								/>
							</div>
						</>
