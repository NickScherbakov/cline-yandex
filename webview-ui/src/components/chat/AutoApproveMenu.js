...
var AutoApproveMenu = function (_a) {
    ...
    var _c = (0, react_2.useState)(false), isHoveringCollapsibleSection = _c[0], setIsHoveringCollapsibleSection = _c[1];
    // Careful not to use partials to mutate since spread operator only does shallow copy
    var enabledActions = ACTION_METADATA.filter(function (action) { return autoApprovalSettings.actions[action.id]; });
    var enabledActionsList = enabledActions.map(function (action) { return action.shortName; }).join(", ");
    var hasEnabledActions = enabledActions.length > 0;
    var updateEnabled = (0, react_2.useCallback)(function (enabled) {
        vscode_1.vscode.postMessage({
            type: "autoApprovalSettings",
            autoApprovalSettings: __assign(__assign({}, autoApprovalSettings), { enabled: enabled }),
        });
    }, [autoApprovalSettings]);
    var updateAction = (0, react_2.useCallback)(function (actionId, value) {
        var _a;
        ...
        vscode_1.vscode.postMessage({
            type: "autoApprovalSettings",
            autoApprovalSettings: __assign(__assign({}, autoApprovalSettings), { actions: newActions, 
    ...
    var updateMaxRequests = (0, react_2.useCallback)(function (maxRequests) {
        vscode_1.vscode.postMessage({
            type: "autoApprovalSettings",
            autoApprovalSettings: __assign(__assign({}, autoApprovalSettings), { maxRequests: maxRequests }),
        });
    }, [autoApprovalSettings]);
    var updateNotifications = (0, react_2.useCallback)(function (enableNotifications) {
        vscode_1.vscode.postMessage({
            type: "autoApprovalSettings",
            autoApprovalSettings: __assign(__assign({}, autoApprovalSettings), { enableNotifications: enableNotifications }),
        });
    }, [autoApprovalSettings]);
    return (<div style={__assign({ padding: "0 15px", userSelect: "none", borderTop: isExpanded
                ? "0.5px solid color-mix(in srgb, ".concat((0, vscStyles_1.getAsVar)(vscStyles_1.VSC_TITLEBAR_INACTIVE_FOREGROUND), " 20%, transparent)")
                : "none", overflowY: "auto" }, style)}>
			<div style={{
            display: "flex",
            alignItems: "center",
            gap: "8px",
            ...
            if (!hasEnabledActions) {
				...
				<react_1.VSCodeCheckbox style={{
            pointerEvents: hasEnabledActions ? "auto" : "none",
        }} checked={hasEnabledActions && autoApprovalSettings.enabled} disabled={!hasEnabledActions} 
    // onChange={(e) => {
    ...
    onClick={function (e) {
            ...
            */
            ...
            updateEnabled(!autoApprovalSettings.enabled);
				...
				<CollapsibleSection isHovered={isHoveringCollapsibleSection} style={{ cursor: "pointer" }} onClick={function () {
            ...
            textOverflow: "ellipsis",
					...
					<span className={"codicon codicon-chevron-".concat(isExpanded ? "down" : "right")} style={{
            flexShrink: 0,
            marginLeft: isExpanded ? "2px" : "-2px",
        }}/>
				</CollapsibleSection>
			</div>
			{isExpanded && (<div style={{ padding: "0" }}>
					<div style={{
                marginBottom: "10px",
                ...
                fontSize: "12px",
					...
					{ACTION_METADATA.map(function (action) { return (<div key={action.id} style={{ margin: "6px 0" }}>
							<react_1.VSCodeCheckbox checked={autoApprovalSettings.actions[action.id]} onChange={function (e) {
        ...
        value={autoApprovalSettings.maxRequests.toString()} onInput={function (e) {
                var input = e.target;
                ...
                marginBottom: "10px",
					...
					<div style={{ margin: "6px 0" }}>
						<react_1.VSCodeCheckbox checked={autoApprovalSettings.enableNotifications} onChange={function (e) {
                var checked = e.target.checked;
...
var CollapsibleSection = styled_components_1.default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n\tdisplay: flex;\n\talign-items: center;\n\tgap: 4px;\n\tcolor: ", ";\n\tflex: 1;\n\tmin-width: 0;\n\n\t&:hover {\n\t\tcolor: ", ";\n\t}\n"], ["\n\tdisplay: flex;\n\talign-items: center;\n\tgap: 4px;\n\tcolor: ", ";\n\tflex: 1;\n\tmin-width: 0;\n\n\t&:hover {\n\t\tcolor: ", ";\n\t}\n"])), function (props) { return (props.isHovered ? (0, vscStyles_1.getAsVar)(vscStyles_1.VSC_FOREGROUND) : (0, vscStyles_1.getAsVar)(vscStyles_1.VSC_DESCRIPTION_FOREGROUND)); }, (0, vscStyles_1.getAsVar)(vscStyles_1.VSC_FOREGROUND));
