...
var ButtonWrapper = styled_components_1.default.div(
	templateObject_2 ||
...
var TaskFeedbackButtons = function (_a) {
	var messageTs = _a.messageTs,
		_b = _a.isFromHistory,
		isFromHistory = _b === void 0 ? false : _b,
		style = _a.style
			...
			<ButtonsContainer>
				<ButtonWrapper>
					<react_2.VSCodeButton
						appearance="icon"
						onClick={function () {
							return handleFeedback("thumbs_up")
						}}
						...
						<IconWrapper>
							<span
								className={"codicon ".concat(
									feedback === "thumbs_up" ? "codicon-thumbsup-filled" : "codicon-thumbsup",
								)}
							/>
						</IconWrapper>
					</react_2.VSCodeButton>
				...
				<ButtonWrapper>
					<react_2.VSCodeButton
						appearance="icon"
						onClick={function () {
							return handleFeedback("thumbs_down")
						}}
