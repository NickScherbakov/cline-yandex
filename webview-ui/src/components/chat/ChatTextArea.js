...
var SwitchOption = styled_components_1.default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n\tpadding: 2px 8px;\n\tcolor: ", ";\n\tz-index: 1;\n\ttransition: color 0.2s ease;\n\tfont-size: 12px;\n\twidth: 50%;\n\ttext-align: center;\n\n\t&:hover {\n\t\tbackground-color: ", ";\n\t}\n"], ["\n\tpadding: 2px 8px;\n\tcolor: ", ";\n\tz-index: 1;\n\ttransition: color 0.2s ease;\n\tfont-size: 12px;\n\twidth: 50%;\n\ttext-align: center;\n\n\t&:hover {\n\t\tbackground-color: ", ";\n\t}\n"])), function (props) { return (props.isActive ? "white" : "var(--vscode-input-foreground)"); }, function (props) { return (!props.isActive ? "var(--vscode-toolbar-hoverBackground)" : "transparent"); });
var SwitchContainer = styled_components_1.default.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n\tdisplay: flex;\n\talign-items: center;\n\tbackground-color: var(--vscode-editor-background);\n\tborder: 1px solid var(--vscode-input-border);\n\tborder-radius: 12px;\n\toverflow: hidden;\n\tcursor: ", ";\n\topacity: ", ";\n\ttransform: scale(0.85);\n\ttransform-origin: right center;\n\tmargin-left: -10px; // compensate for the transform so flex spacing works\n\tuser-select: none; // Prevent text selection\n"], ["\n\tdisplay: flex;\n\talign-items: center;\n\tbackground-color: var(--vscode-editor-background);\n\tborder: 1px solid var(--vscode-input-border);\n\tborder-radius: 12px;\n\toverflow: hidden;\n\tcursor: ", ";\n\topacity: ", ";\n\ttransform: scale(0.85);\n\ttransform-origin: right center;\n\tmargin-left: -10px; // compensate for the transform so flex spacing works\n\tuser-select: none; // Prevent text selection\n"])), function (props) { return (props.disabled ? "not-allowed" : "pointer"); }, function (props) { return (props.disabled ? 0.5 : 1); });
var Slider = styled_components_1.default.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n\tposition: absolute;\n\theight: 100%;\n\twidth: 50%;\n\tbackground-color: ", ";\n\ttransition: transform 0.2s ease;\n\ttransform: translateX(", ");\n"], ["\n\tposition: absolute;\n\theight: 100%;\n\twidth: 50%;\n\tbackground-color: ", ";\n\ttransition: transform 0.2s ease;\n\ttransform: translateX(", ");\n"])), function (props) { return (props.isPlan ? PLAN_MODE_COLOR : "var(--vscode-focusBorder)"); }, function (props) { return (props.isAct ? "100%" : "0%"); });
...
var ControlsContainer = styled_components_1.default.div(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n\tdisplay: flex;\n\talign-items: center;\n\tjustify-content: space-between;\n\tmargin-top: -5px;\n\tpadding: 0px 15px 5px 15px;\n"], ["\n\tdisplay: flex;\n\talign-items: center;\n\tjustify-content: space-between;\n\tmargin-top: -5px;\n\tpadding: 0px 15px 5px 15px;\n"])));
var ModelSelectorTooltip = styled_components_1.default.div(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n\tposition: fixed;\n\tbottom: calc(100% + 9px);\n\tleft: 15px;\n\tright: 15px;\n\tbackground: ", ";\n\tborder: 1px solid var(--vscode-editorGroup-border);\n\tpadding: 12px;\n\tborder-radius: 3px;\n\tz-index: 1000;\n\tmax-height: calc(100vh - 100px);\n\toverflow-y: auto;\n\toverscroll-behavior: contain;\n\n\t// Add invisible padding for hover zone\n\t&::before {\n\t\tcontent: \"\";\n\t\tposition: fixed;\n\t\tbottom: ", ";\n\t\tleft: 0;\n\t\tright: 0;\n\t\theight: 8px;\n\t}\n\n\t// Arrow pointing down\n\t&::after {\n\t\tcontent: \"\";\n\t\tposition: fixed;\n\t\tbottom: ", ";\n\t\tright: ", "px;\n\t\twidth: 10px;\n\t\theight: 10px;\n\t\tbackground: ", ";\n\t\tborder-right: 1px solid var(--vscode-editorGroup-border);\n\t\tborder-bottom: 1px solid var(--vscode-editorGroup-border);\n\t\ttransform: rotate(45deg);\n\t\tz-index: -1;\n\t}\n"], ["\n\tposition: fixed;\n\tbottom: calc(100% + 9px);\n\tleft: 15px;\n\tright: 15px;\n\tbackground: ", ";\n\tborder: 1px solid var(--vscode-editorGroup-border);\n\tpadding: 12px;\n\tborder-radius: 3px;\n\tz-index: 1000;\n\tmax-height: calc(100vh - 100px);\n\toverflow-y: auto;\n\toverscroll-behavior: contain;\n\n\t// Add invisible padding for hover zone\n\t&::before {\n\t\tcontent: \"\";\n\t\tposition: fixed;\n\t\tbottom: ", ";\n\t\tleft: 0;\n\t\tright: 0;\n\t\theight: 8px;\n\t}\n\n\t// Arrow pointing down\n\t&::after {\n\t\tcontent: \"\";\n\t\tposition: fixed;\n\t\tbottom: ", ";\n\t\tright: ", "px;\n\t\twidth: 10px;\n\t\theight: 10px;\n\t\tbackground: ", ";\n\t\tborder-right: 1px solid var(--vscode-editorGroup-border);\n\t\tborder-bottom: 1px solid var(--vscode-editorGroup-border);\n\t\ttransform: rotate(45deg);\n\t\tz-index: -1;\n\t}\n"])), CodeBlock_1.CODE_BLOCK_BG_COLOR, function (props) { return "calc(100vh - ".concat(props.menuPosition, "px - 2px)"); }, function (props) { return "calc(100vh - ".concat(props.menuPosition, "px)"); }, function (props) { return props.arrowPosition; }, CodeBlock_1.CODE_BLOCK_BG_COLOR);
var ModelContainer = styled_components_1.default.div(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n\tposition: relative;\n\tdisplay: flex;\n\tflex: 1;\n\tmin-width: 0;\n"], ["\n\tposition: relative;\n\tdisplay: flex;\n\tflex: 1;\n\tmin-width: 0;\n"])));
var ModelButtonWrapper = styled_components_1.default.div(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n\tdisplay: inline-flex; // Make it shrink to content\n\tmin-width: 0; // Allow shrinking\n\tmax-width: 100%; // Don't overflow parent\n"], ["\n\tdisplay: inline-flex; // Make it shrink to content\n\tmin-width: 0; // Allow shrinking\n\tmax-width: 100%; // Don't overflow parent\n"])));
var ModelDisplayButton = styled_components_1.default.a(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n\tpadding: 0px 0px;\n\theight: 20px;\n\twidth: 100%;\n\tmin-width: 0;\n\tcursor: ", ";\n\ttext-decoration: ", ";\n\tcolor: ", ";\n\tdisplay: flex;\n\talign-items: center;\n\tfont-size: 10px;\n\toutline: none;\n\tuser-select: none;\n\topacity: ", ";\n\tpointer-events: ", ";\n\n\t&:hover,\n\t&:focus {\n\t\tcolor: ", ";\n\t\ttext-decoration: ", ";\n\t\toutline: none;\n\t}\n\n\t&:active {\n\t\tcolor: ", ";\n\t\ttext-decoration: ", ";\n\t\toutline: none;\n\t}\n\n\t&:focus-visible {\n\t\toutline: none;\n\t}\n"], ["\n\tpadding: 0px 0px;\n\theight: 20px;\n\twidth: 100%;\n\tmin-width: 0;\n\tcursor: ", ";\n\ttext-decoration: ", ";\n\tcolor: ", ";\n\tdisplay: flex;\n\talign-items: center;\n\tfont-size: 10px;\n\toutline: none;\n\tuser-select: none;\n\topacity: ", ";\n\tpointer-events: ", ";\n\n\t&:hover,\n\t&:focus {\n\t\tcolor: ", ";\n\t\ttext-decoration: ", ";\n\t\toutline: none;\n\t}\n\n\t&:active {\n\t\tcolor: ", ";\n\t\ttext-decoration: ", ";\n\t\toutline: none;\n\t}\n\n\t&:focus-visible {\n\t\toutline: none;\n\t}\n"])), function (props) { return (props.disabled ? "not-allowed" : "pointer"); }, function (props) { return (props.isActive ? "underline" : "none"); }, function (props) { return (props.isActive ? "var(--vscode-foreground)" : "var(--vscode-descriptionForeground)"); }, function (props) { return (props.disabled ? 0.5 : 1); }, function (props) { return (props.disabled ? "none" : "auto"); }, function (props) { return (props.disabled ? "var(--vscode-descriptionForeground)" : "var(--vscode-foreground)"); }, function (props) { return (props.disabled ? "none" : "underline"); }, function (props) { return (props.disabled ? "var(--vscode-descriptionForeground)" : "var(--vscode-foreground)"); }, function (props) { return (props.disabled ? "none" : "underline"); });
var ModelButtonContent = styled_components_1.default.div(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n\twidth: 100%;\n\tmin-width: 0;\n\toverflow: hidden;\n\ttext-overflow: ellipsis;\n\twhite-space: nowrap;\n"], ["\n\twidth: 100%;\n\tmin-width: 0;\n\toverflow: hidden;\n\ttext-overflow: ellipsis;\n\twhite-space: nowrap;\n"])));
var ChatTextArea = (0, react_2.forwardRef)(function (_a, ref) {
    var inputValue = _a.inputValue, setInputValue = _a.setInputValue, textAreaDisabled = _a.textAreaDisabled, placeholderText = _a.placeholderText, selectedImages = _a.selectedImages, setSelectedImages = _a.setSelectedImages, onSend = _a.onSend, onSelectImages = _a.onSelectImages, shouldDisableImages = _a.shouldDisableImages, onHeightChange = _a.onHeightChange;
    var _b = (0, ExtensionStateContext_1.useExtensionState)(), filePaths = _b.filePaths, chatSettings = _b.chatSettings, apiConfiguration = _b.apiConfiguration, openRouterModels = _b.openRouterModels, platform = _b.platform;
    var _c = (0, react_2.useState)(false), isTextAreaFocused = _c[0], setIsTextAreaFocused = _c[1];
    var _d = (0, react_2.useState)([]), gitCommits = _d[0], setGitCommits = _d[1];
    var _e = (0, react_2.useState)(0), thumbnailsHeight = _e[0], setThumbnailsHeight = _e[1];
    var _f = (0, react_2.useState)(undefined), textAreaBaseHeight = _f[0], setTextAreaBaseHeight = _f[1];
    var _g = (0, react_2.useState)(false), showContextMenu = _g[0], setShowContextMenu = _g[1];
    var _h = (0, react_2.useState)(0), cursorPosition = _h[0], setCursorPosition = _h[1];
    var _j = (0, react_2.useState)(""), searchQuery = _j[0], setSearchQuery = _j[1];
    var textAreaRef = (0, react_2.useRef)(null);
    var _k = (0, react_2.useState)(false), isMouseDownOnMenu = _k[0], setIsMouseDownOnMenu = _k[1];
    var highlightLayerRef = (0, react_2.useRef)(null);
    var _l = (0, react_2.useState)(-1), selectedMenuIndex = _l[0], setSelectedMenuIndex = _l[1];
    var _m = (0, react_2.useState)(null), selectedType = _m[0], setSelectedType = _m[1];
    var _o = (0, react_2.useState)(false), justDeletedSpaceAfterMention = _o[0], setJustDeletedSpaceAfterMention = _o[1];
    var _p = (0, react_2.useState)(null), intendedCursorPosition = _p[0], setIntendedCursorPosition = _p[1];
    var contextMenuContainerRef = (0, react_2.useRef)(null);
    var _q = (0, react_2.useState)(false), showModelSelector = _q[0], setShowModelSelector = _q[1];
    var modelSelectorRef = (0, react_2.useRef)(null);
    var _r = (0, react_use_1.useWindowSize)(), viewportWidth = _r.width, viewportHeight = _r.height;
    var buttonRef = (0, react_2.useRef)(null);
    var _s = (0, react_2.useState)(0), arrowPosition = _s[0], setArrowPosition = _s[1];
    var _t = (0, react_2.useState)(0), menuPosition = _t[0], setMenuPosition = _t[1];
    var _u = (0, react_2.useState)(null), shownTooltipMode = _u[0], setShownTooltipMode = _u[1];
    var _v = (0, react_2.useState)([]), fileSearchResults = _v[0], setFileSearchResults = _v[1];
    var _w = (0, react_2.useState)(false), searchLoading = _w[0], setSearchLoading = _w[1];
    var _x = (0, hooks_1.useMetaKeyDetection)(platform), metaKeyChar = _x[1];
    ...
    var handleMessage = (0, react_2.useCallback)(function (event) {
        ...
        switch (message.type) {
            case "commitSearchResults": {
                var commits = ((_a = message.commits) === null || _a === void 0 ? void 0 : _a.map(function (commit) { return ({
                    type: context_mentions_2.ContextMenuOptionType.Git,
                    value: commit.hash,
                    label: commit.subject,
                    description: "".concat(commit.shortHash, " by ").concat(commit.author, " on ").concat(commit.date),
                }); })) || [];
    ...
    var queryItems = (0, react_2.useMemo)(function () {
        ...
        ], gitCommits, true), filePaths
            .map(function (file) { return "/" + file; })
            .map(function (path) { return ({
            type: path.endsWith("/") ? context_mentions_2.ContextMenuOptionType.Folder : context_mentions_2.ContextMenuOptionType.File,
            value: path,
        }); }), true);
    ...
    var handleMentionSelect = (0, react_2.useCallback)(function (type, value) {
        if (type === context_mentions_2.ContextMenuOptionType.NoResults) {
            return;
        }
        if (type === context_mentions_2.ContextMenuOptionType.File ||
        ...
        if (textAreaRef.current) {
            ...
            else if (type === context_mentions_2.ContextMenuOptionType.File || type === context_mentions_2.ContextMenuOptionType.Folder) {
                insertValue = value || "";
            }
            ...
            var _a = (0, context_mentions_2.insertMention)(textAreaRef.current.value, cursorPosition, insertValue), newValue = _a.newValue, mentionIndex = _a.mentionIndex;
    ...
    var handleKeyDown = (0, react_2.useCallback)(function (event) {
        ...
        if (showContextMenu) {
            ...
            if (event.key === "ArrowUp" || event.key === "ArrowDown") {
                ...
                setSelectedMenuIndex(function (prevIndex) {
                    ...
                    var options = (0, context_mentions_2.getContextMenuOptions)(searchQuery, selectedType, queryItems, fileSearchResults);
                    var optionsLength = options.length;
                    if (optionsLength === 0)
                        return prevIndex;
                    // Find selectable options (non-URL types)
                    var selectableOptions = options.filter(function (option) {
                        return option.type !== context_mentions_2.ContextMenuOptionType.URL && option.type !== context_mentions_2.ContextMenuOptionType.NoResults;
                    });
                    if (selectableOptions.length === 0)
                        return -1; // No selectable options
                    // Find the index of the next selectable option
                    var currentSelectableIndex = selectableOptions.findIndex(function (option) { return option === options[prevIndex]; });
                    var newSelectableIndex = (currentSelectableIndex + direction + selectableOptions.length) % selectableOptions.length;
                    // Find the index of the selected option in the original options array
                    return options.findIndex(function (option) { return option === selectableOptions[newSelectableIndex]; });
                });
                return;
            }
            if ((event.key === "Enter" || event.key === "Tab") && selectedMenuIndex !== -1) {
                event.preventDefault();
                var selectedOption = (0, context_mentions_2.getContextMenuOptions)(searchQuery, selectedType, queryItems, fileSearchResults)[selectedMenuIndex];
                if (selectedOption &&
        ...
        var isComposing = (_b = (_a = event.nativeEvent) === null || _a === void 0 ? void 0 : _a.isComposing) !== null && _b !== void 0 ? _b : false;
        ...
        if (event.key === "Backspace" && !isComposing) {
            ...
            if (charBeforeIsWhitespace &&
                ...
                if (!charAfterIsWhitespace) {
                    event.preventDefault();
                    (_c = textAreaRef.current) === null || _c === void 0 ? void 0 : _c.setSelectionRange(newCursorPosition, newCursorPosition);
                    setCursorPosition(newCursorPosition);
                }
                setCursorPosition(newCursorPosition);
                ...
                var _d = (0, context_mentions_2.removeMention)(inputValue, cursorPosition), newText = _d.newText, newPosition = _d.newPosition;
    ...
    var handleInputChange = (0, react_2.useCallback)(function (e) {
    ...
    var handleBlur = (0, react_2.useCallback)(function () {
    ...
    var handlePaste = (0, react_2.useCallback)(function (e) { return __awaiter(void 0, void 0, void 0, function () {
        var items, pastedText, urlRegex, trimmedUrl, newValue, newCursorPosition, acceptedTypes, imageItems, imagePromises, imageDataArray, dataUrls_1;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (urlRegex.test(pastedText.trim())) {
                        ...
                        newValue = inputValue.slice(0, cursorPosition) + trimmedUrl + " " + inputValue.slice(cursorPosition);
                        setInputValue(newValue);
                    ...
                    imageItems = Array.from(items).filter(function (item) {
                        var _a = item.type.split("/"), type = _a[0], subtype = _a[1];
                ...
                case 1:
                    ...
                    dataUrls_1 = imageDataArray.filter(function (dataUrl) { return dataUrl !== null; });
                    //.map((dataUrl) => dataUrl.split(",")[1]) // strip the mime type prefix, sharp doesn't need it
                    if (dataUrls_1.length > 0) {
                        setSelectedImages(function (prevImages) { return __spreadArray(__spreadArray([], prevImages, true), dataUrls_1, true).slice(0, ChatView_1.MAX_IMAGES_PER_MESSAGE); });
                    }
                    else {
    ...
    var handleKeyUp = (0, react_2.useCallback)(function (e) {
        if (["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Home", "End"].includes(e.key)) {
            updateCursorPosition();
        }
    }, [updateCursorPosition]);
    // Separate the API config submission logic
    var submitApiConfig = (0, react_2.useCallback)(function () {
    ...
    var onModeToggle = (0, react_2.useCallback)(function () {
    ...
    var handleContextButtonClick = (0, react_2.useCallback)(function () {
        var _a;
        if (textAreaDisabled)
            return;
    ...
    var modelDisplayName = (0, react_2.useMemo)(function () {
        var _a, _b;
        var _c = (0, ApiOptions_1.normalizeApiConfiguration)(apiConfiguration), selectedProvider = _c.selectedProvider, selectedModelId = _c.selectedModelId;
        ...
        switch (selectedProvider) {
            ...
            case "vscode-lm":
                return "vscode-lm:".concat(apiConfiguration.vsCodeLmModelSelector ? "".concat((_a = apiConfiguration.vsCodeLmModelSelector.vendor) !== null && _a !== void 0 ? _a : "", "/").concat((_b = apiConfiguration.vsCodeLmModelSelector.family) !== null && _b !== void 0 ? _b : "") : unknownModel);
            case "together":
            ...
            switch (_a.label) {
                case 0:
                    ...
                    imageFiles = files.filter(function (file) {
                        var _a = file.type.split("/"), type = _a[0], subtype = _a[1];
                        return type === "image" && acceptedTypes.includes(subtype);
                    });
                ...
                case 1:
                    imageDataArray = _a.sent();
                    dataUrls = imageDataArray.filter(function (dataUrl) { return dataUrl !== null; });
                    if (dataUrls.length > 0) {
                        setSelectedImages(function (prevImages) { return __spreadArray(__spreadArray([], prevImages, true), dataUrls, true).slice(0, ChatView_1.MAX_IMAGES_PER_MESSAGE); });
                    }
                    else {
                        console.warn("No valid images were processed");
                    }
    ...
    return (<div>
            ...
            display: "flex",
					...
					{showContextMenu && (<div ref={contextMenuContainerRef}>
							<ContextMenu_1.default onSelect={handleMentionSelect} searchQuery={searchQuery} onMouseDown={handleMenuMouseDown} selectedIndex={selectedMenuIndex} setSelectedIndex={setSelectedMenuIndex} selectedType={selectedType} queryItems={queryItems} dynamicSearchResults={fileSearchResults} isLoading={searchLoading}/>
						</div>)}
					{!isTextAreaFocused && (<div style={{
                position: "absolute",
                inset: "10px 15px",
                border: "1px solid var(--vscode-input-border)",
                borderRadius: 2,
                ...
                zIndex: 5,
					...
					<div ref={highlightLayerRef} style={{
            position: "absolute",
            top: 10,
            left: 15,
            right: 15,
            ...
            padding: "9px 28px 3px 9px",
					...
					<react_textarea_autosize_1.default data-testid="chat-input" ref={function (el) {
        ...
        }} value={inputValue} disabled={textAreaDisabled} onChange={function (e) {
            handleInputChange(e);
            updateHighlights();
        }} onKeyDown={handleKeyDown} onKeyUp={handleKeyUp} onFocus={function () { return setIsTextAreaFocused(true); }} onBlur={handleBlur} onPaste={handlePaste} onSelect={updateCursorPosition} onMouseUp={updateCursorPosition} onHeightChange={function (height) {
            if (textAreaBaseHeight === undefined || height < textAreaBaseHeight) {
                setTextAreaBaseHeight(height);
            }
            onHeightChange === null || onHeightChange === void 0 ? void 0 : onHeightChange(height);
        }} placeholder={placeholderText} maxRows={10} autoFocus={true} style={{
            width: "100%",
            ...
            outline: isTextAreaFocused
                ...
                : "none",
        }} onScroll={function () { return updateHighlights(); }}/>
					{selectedImages.length > 0 && (<Thumbnails_1.default images={selectedImages} setImages={setSelectedImages} onHeightChange={handleThumbnailsHeightChange} style={{
                position: "absolute",
                paddingTop: 4,
                bottom: 14,
                left: 22,
        ...
        /> */}
							<div data-testid="send-button" className={"input-icon-button ".concat(textAreaDisabled ? "disabled" : "", " codicon codicon-send")} onClick={function () {
            if (!textAreaDisabled) {
                setIsTextAreaFocused(false);
                onSend();
            }
				...
				<ControlsContainer>
					<ButtonGroup>
						<react_1.VSCodeButton data-testid="context-button" appearance="icon" aria-label="Add Context" disabled={textAreaDisabled} onClick={handleContextButtonClick} style={{ padding: "0px 0px", height: "20px" }}>
							<ButtonContainer>
						...
						<react_1.VSCodeButton data-testid="images-button" appearance="icon" aria-label="Add Images" disabled={shouldDisableImages} onClick={function () {
            if (!shouldDisableImages) {
                onSelectImages();
            }
						...
						<ModelContainer ref={modelSelectorRef}>
							<ModelButtonWrapper ref={buttonRef}>
								<ModelDisplayButton role="button" isActive={showModelSelector} disabled={false} onClick={handleModelButtonClick} 
    // onKeyDown={(e) => {
    ...
    tabIndex={0}>
							...
							{showModelSelector && (<ModelSelectorTooltip arrowPosition={arrowPosition} menuPosition={menuPosition} style={{
                bottom: "calc(100vh - ".concat(menuPosition, "px + 6px)"),
            }}>
									<ApiOptions_1.default showModelOptions={true} apiErrorMessage={undefined} modelIdErrorMessage={undefined} isPopup={true}/>
								</ModelSelectorTooltip>)}
						</ModelContainer>
					</ButtonGroup>
					<Tooltip_1.default style={{ zIndex: 1000 }} visible={shownTooltipMode !== null} tipText={"In ".concat(shownTooltipMode === "act" ? "Act" : "Plan", "  mode, Cline will ").concat(shownTooltipMode === "act" ? "complete the task immediately" : "gather information to architect a plan")} hintText={"Toggle w/ ".concat(metaKeyChar, "+Shift+A")}>
						<SwitchContainer data-testid="mode-switch" disabled={false} onClick={onModeToggle}>
							<Slider isAct={chatSettings.mode === "act"} isPlan={chatSettings.mode === "plan"}/>
							<SwitchOption isActive={chatSettings.mode === "plan"} onMouseOver={function () { return setShownTooltipMode("plan"); }} onMouseLeave={function () { return setShownTooltipMode(null); }}>
								Plan
							</SwitchOption>
							<SwitchOption isActive={chatSettings.mode === "act"} onMouseOver={function () { return setShownTooltipMode("act"); }} onMouseLeave={function () { return setShownTooltipMode(null); }}>
								Act
							</SwitchOption>
						</SwitchContainer>
					</Tooltip_1.default>
