...
var OpenAiModelPicker = function () {
    var _a = (0, ExtensionStateContext_1.useExtensionState)(), apiConfiguration = _a.apiConfiguration, setApiConfiguration = _a.setApiConfiguration, openAiModels = _a.openAiModels;
    var _b = (0, react_2.useState)((apiConfiguration === null || apiConfiguration === void 0 ? void 0 : apiConfiguration.openAiModelId) || ""), searchTerm = _b[0], setSearchTerm = _b[1];
    var _c = (0, react_2.useState)(false), isDropdownVisible = _c[0], setIsDropdownVisible = _c[1];
    var _d = (0, react_2.useState)(-1), selectedIndex = _d[0], setSelectedIndex = _d[1];
    ...
    }, [apiConfiguration === null || apiConfiguration === void 0 ? void 0 : apiConfiguration.openAiBaseUrl, apiConfiguration === null || apiConfiguration === void 0 ? void 0 : apiConfiguration.openAiApiKey]);
    (0, react_2.useEffect)(function () {
    ...
    var modelIds = (0, react_2.useMemo)(function () {
        return openAiModels.sort(function (a, b) { return a.localeCompare(b); });
    }, [openAiModels]);
    ...
    return (<>
        ...
        }} onFocus={function () { return setIsDropdownVisible(true); }} onKeyDown={handleKeyDown} style={{ width: "100%", zIndex: exports.OPENAI_MODEL_PICKER_Z_INDEX, position: "relative" }}>
...
exports.ModelDescriptionMarkdown = (0, react_2.memo)(function (_a) {
    var markdown = _a.markdown, key = _a.key, isExpanded = _a.isExpanded, setIsExpanded = _a.setIsExpanded;
