...
var OpenRouterModelPicker = function (_a) {
	...
	var _b = (0, ExtensionStateContext_1.useExtensionState)(),
		...
		setApiConfiguration = _b.setApiConfiguration,
	...
	var _d = (0, react_2.useState)(false),
		isDropdownVisible = _d[0],
		setIsDropdownVisible = _d[1]
	var _e = (0, react_2.useState)(-1),
		selectedIndex = _e[0],
		setSelectedIndex = _e[1]
	var dropdownRef = (0, react_2.useRef)(null)
	var itemRefs = (0, react_2.useRef)([])
	var _f = (0, react_2.useState)(false),
		isDescriptionExpanded = _f[0],
		setIsDescriptionExpanded = _f[1]
	...
	var _g = (0, react_2.useMemo)(
			function () {
				return (0, ApiOptions_1.normalizeApiConfiguration)(apiConfiguration)
			},
			[apiConfiguration],
		),
		selectedModelId = _g.selectedModelId,
		selectedModelInfo = _g.selectedModelInfo
	...
	var modelIds = (0, react_2.useMemo)(
		function () {
			var unfilteredModelIds = Object.keys(openRouterModels).sort(function (a, b) {
				return a.localeCompare(b)
			})
			return (apiConfiguration === null || apiConfiguration === void 0 ? void 0 : apiConfiguration.apiProvider) === "cline"
				? unfilteredModelIds.filter(function (id) {
	...
	var hasInfo = (0, react_2.useMemo)(
		function () {
			try {
				return modelIds.some(function (id) {
					return id.toLowerCase() === searchTerm.toLowerCase()
				})
			} catch (_a) {
				return false
			}
	...
	var showBudgetSlider = (0, react_2.useMemo)(
		function () {
			return (
				(selectedModelId === null || selectedModelId === void 0
					? void 0
			...
			<div style={{ display: "flex", flexDirection: "column" }}>
				...
				{(apiConfiguration === null || apiConfiguration === void 0 ? void 0 : apiConfiguration.apiProvider) ===
					...
					<div style={{ marginBottom: "6px", marginTop: 4 }}>
						{featuredModels.map(function (model) {
							return (
								<FeaturedModelCard_1.default
									key={model.id}
									modelId={model.id}
				...
				<p
					...
					<>
						...
						<react_1.VSCodeLink
							style={{ display: "inline", fontSize: "inherit" }}
							onClick={function () {
								return handleModelChange("anthropic/claude-3.7-sonnet")
							}}>
