...
vitest_1.vi.mock("../../../context/ExtensionStateContext", function (importOriginal) { return __awaiter(void 0, void 0, void 0, function () {
    var actual;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                actual = _a.sent();
                return [2 /*return*/, __assign(__assign({}, actual), { 
                        // your mocked methods
                        useExtensionState: vitest_1.vi.fn(function () { return ({
                            apiConfiguration: {
...
(0, vitest_1.describe)("ApiOptions Component", function () {
    ...
    (0, vitest_1.it)("renders Requesty API Key input", function () {
        (0, react_1.render)(<ExtensionStateContext_1.ExtensionStateContextProvider>
