...
var SettingsView = function (_a) {
	...
	var _b = (0, ExtensionStateContext_1.useExtensionState)(),
		...
		version = _b.version,
		customInstructions = _b.customInstructions,
		setCustomInstructions = _b.setCustomInstructions,
		openRouterModels = _b.openRouterModels,
		telemetrySetting = _b.telemetrySetting,
		setTelemetrySetting = _b.setTelemetrySetting,
		chatSettings = _b.chatSettings,
		planActSeparateModelsSetting = _b.planActSeparateModelsSetting,
		setPlanActSeparateModelsSetting = _b.setPlanActSeparateModelsSetting
	var _c = (0, react_2.useState)(undefined),
		apiErrorMessage = _c[0],
		setApiErrorMessage = _c[1]
	var _d = (0, react_2.useState)(undefined),
		modelIdErrorMessage = _d[0],
		setModelIdErrorMessage = _d[1]
	var _e = (0, react_2.useState)(null),
		pendingTabChange = _e[0],
		setPendingTabChange = _e[1]
	var handleSubmit = function (withoutDone) {
		if (withoutDone === void 0) {
			withoutDone = false
		}
			...
			<div
				...
				<div style={{ marginBottom: 5 }}>
					<react_1.VSCodeTextArea
						value={customInstructions !== null && customInstructions !== void 0 ? customInstructions : ""}
						style={{ width: "100%" }}
						resize="vertical"
						rows={4}
				...
				<div
					...
					<SettingsButton_1.default
						onClick={function () {
							return vscode_1.vscode.postMessage({ type: "openExtensionSettings" })
						}}
						style={{
							margin: "0 0 16px 0",
						}}>
