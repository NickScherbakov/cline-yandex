...
export declare const DropdownContainer: import("styled-components/dist/types").IStyledComponentBase<
	"web",
...
export declare const ModelInfoView: ({
	selectedModelId,
	modelInfo,
...
declare const _default: import("react").MemoExoticComponent<
	({ showModelOptions, apiErrorMessage, modelIdErrorMessage, isPopup }: ApiOptionsProps) => import("react").JSX.Element
>
