...
var ClineAccountInfoCard = function () {
    var _a = (0, FirebaseAuthContext_1.useFirebaseAuth)(), firebaseUser = _a.user, handleSignOut = _a.handleSignOut;
    var _b = (0, ExtensionStateContext_1.useExtensionState)(), userInfo = _b.userInfo, apiConfiguration = _b.apiConfiguration;
    ...
    return (<div className="max-w-[600px]">
			{user ? (<react_1.VSCodeButton appearance="secondary" onClick={handleShowAccount}>
					View Billing & Usage
