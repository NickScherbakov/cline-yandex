...
var AppContent = function () {
	var _a = (0, ExtensionStateContext_1.useExtensionState)(),
		didHydrateState = _a.didHydrateState,
		showWelcome = _a.showWelcome,
		shouldShowAnnouncement = _a.shouldShowAnnouncement,
		telemetrySetting = _a.telemetrySetting,
		vscMachineId = _a.vscMachineId
	...
	var _f = (0, react_1.useState)(false),
		showAnnouncement = _f[0],
		setShowAnnouncement = _f[1]
		...
		<>
			{showWelcome ? (
				...
				<>
					...
					{showMcp && (
						<McpConfigurationView_1.default
							onDone={function () {
								return setShowMcp(false)
							}}
						/>
					)}
					{showAccount && (
						<AccountView_1.default
							onDone={function () {
